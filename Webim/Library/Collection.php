...
class Collection implements ArrayAccess, Countable, IteratorAggregate, JsonSerializable {
  ...
  public function diff($items) {
    return new static(array_diff($this->collapse()->all(), $this->getArrayableItems($items)));
  }
  ...
  public function collapse() {
    ...
    foreach ($this->items as $values) {
      $results = array_merge($results, (array)$values);
    }
   ...
   * @param array $items
   */
  public function replace($items = array()) {
  ...
  public function sum($callback) {
    ...
    return $this->reduce(function (array $result, $item) use ($callback) {
